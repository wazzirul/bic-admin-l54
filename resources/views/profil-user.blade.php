            ...
            <div class="card col-xs-12">
                ...
                <div class="card-body">
                    ...
                    <div id="profil-user_wrapper" class="dataTables_wrapper no-footer">
                        <table id="profil-user" class="table mb-3 table-hover table-profil-user table-setting dataTable no-footer" style="width:100%" role="grid" aria-describedby="profil-user_info">
                        <thead>
                            <tr role="row">
